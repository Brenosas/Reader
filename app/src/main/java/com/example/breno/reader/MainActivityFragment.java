package com.example.breno.reader;
...
public class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Criando um array falsa de strings com os titulos das nossas Aulas
        String[] data= {
        ...
        //Criando uma lista (ArrayList) com os dados acima
        ...
        ArrayAdapter<String> listOfLastPostsAdapter = new ArrayAdapter<String>(
                ...
                R.layout.list_item_last_posts, // O arquivo layout de cada item
